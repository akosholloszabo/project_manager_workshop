...
@Composable
fun MarkdownParagraph(annotated: AnnotatedString, modifier: Modifier = Modifier) {
    Text(
        text = annotated,
...
@Composable
fun MarkdownParagraphPreviewLight() {
    hu.akosholloszabo.project_manager.project_manager_workshop.AppTheme(darkTheme = false) {
        Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
            MarkdownParagraph(annotated = buildAnnotatedString { append("This is a paragraph preview.") })
        }
    }
}
...
@Preview(showBackground = true)
@Composable
fun MarkdownParagraphPreviewDark() {
